...
char UART_ReadRDR(uint8_t var_uartChannel_u8);
...
#define UART1_AttachInterrupt(ptr) UART_AttachInterrupt(C_UartOne_U8,  ptr)
#define UART2_AttachInterrupt(ptr) UART_AttachInterrupt(C_UartTwo_U8,  ptr)
#define UART3_AttachInterrupt(ptr) UART_AttachInterrupt(C_UartThree_U8,  ptr)
...
#define UART0_ReadRDR() UART_ReadRDR(C_UartZero_U8)
#define UART1_ReadRDR() UART_ReadRDR(C_UartOne_U8)
#define UART2_ReadRDR() UART_ReadRDR(C_UartTwo_U8)
#define UART3_ReadRDR() UART_ReadRDR(C_UartThree_U8)
