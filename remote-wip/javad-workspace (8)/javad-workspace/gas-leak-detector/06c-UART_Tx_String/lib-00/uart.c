...
{  /*userFunPtr      TxPin RxPin UART_PinFun   PCON Bit Associated UART Structure      IRQ Number   */
    ...
    {  NULL, UART1_IRQn, P0_15, P0_16, PINSEL_FUNC_1,  4     ,(LPC_UART_TypeDef *)LPC_UART1_BASE}, /* Configure P2_0,P2_1 for UART1 function */
...
void UART_AttachInterrupt(uint8_t var_uartChannel_u8,uartFunPtr funPtr)
{
    ...
    if(var_uartChannel_u8< C_MaxUartChannels_U8)
    {
        UartConfig[var_uartChannel_u8].userFunction = funPtr; /* Stop timer by Clearing the Counter Enable*/
			  ...
			  util_BitClear(UartConfig[var_uartChannel_u8].UARTx->LCR, SBIT_DLAB); 
			  util_BitSet(UartConfig[var_uartChannel_u8].UARTx->IER, SBIT_RDR);  /* Enable Receive Interrupt */
...
void UART1_IRQHandler(void)
{
    ...
    if(UartConfig[C_UartOne_U8].userFunction!=NULL)
    {
        UartConfig[C_UartOne_U8].userFunction();
    }
}
...
//void UART_AttachInterrupt(uint8_t v_uartChannel_u8,uartFunPtr funPtr)
//{
//    if(v_uartChannel_u8<UART_MAX)
//    {
//        UartConfig[v_uartChannel_u8].userFunction = funPtr; /* Stop timer by Clearing the Counter Enable*/
//        NVIC_EnableIRQ(UartConfig[v_uartChannel_u8].IrqNumber); 
//    }
//}
...
//{
//   // util_BitSet(LPC_UART0->IIR,SBIT_uart);  /* Clear Interrupt Flag */

//    if(UartConfig[UART_0].userFunction!=NULL)
//    {
//        UartConfig[UART_0].userFunction();
//    }
//}
//void UART1_IRQHandler(void)
//{
...
//    if(UartConfig[UART_1].userFunction!=NULL)
//    {
//        UartConfig[UART_1].userFunction();
//    }
//}
...
//    if(UartConfig[UART_2].userFunction!=NULL)
//    {
//        UartConfig[UART_2].userFunction();
//    }
//}
...
//    if(UartConfig[UART_3].userFunction!=NULL)
//    {
//        UartConfig[UART_3].userFunction();
//    }
//}
...
char UART_ReadRDR(uint8_t v_uartChannel_u8)
{								
    char ch = 0; 
